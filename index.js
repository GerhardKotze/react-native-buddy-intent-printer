/**
 * @providesModule SendBuddyIntentAndroid
 */

var { Platform, NativeModules } = require("react-native");
var RNSendIntentAndroid = NativeModules.SendBuddyIntentAndroid || {};

var SendBuddyIntentAndroid = {
    ...
    print(printData) {
        return RNSendIntentAndroid.print(printData);
    },
    viewPrint(printData) {
        return RNSendIntentAndroid.viewPrint(printData);
    },
};

module.exports = SendBuddyIntentAndroid;
