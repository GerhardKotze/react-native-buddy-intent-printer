...
public class RNSendIntentModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void print(String printData, final Promise promise) {

        // String printData
        // PrintMode 1 for view print and PrintMode 2 for direct print to device
        Intent printIntent = new Intent("na.buddy.buddymerchantprint.printrequest");
        printIntent.putExtra("PrintMode", 2);
        printIntent.putExtra("PrintData", printData);
        this.reactContext.startActivity(printIntent);
        ...
        @ReactMethod
    public void viewPrint(String printData, final Promise promise) {

        // String printData
        // PrintMode 1 for view print and PrintMode 2 for direct print to device
        Intent printIntent = new Intent("na.buddy.buddymerchantprint.printrequest");
        printIntent.putExtra("PrintMode", 1);
        printIntent.putExtra("PrintData", printData);
        this.reactContext.startActivity(printIntent);
