declare namespace SendBuddyIntentAndroid {
  ...
  const print: (printData: string) => Promise<boolean>
  const viewPrint: (printData: string) => Promise<boolean>
}

export = SendBuddyIntentAndroid